...
from const import ALIGNED_FACES_DIR, AGEDB_RESULTS_PATH, FEATURES_CSV, \
...
if __name__=="__main__":
    _ = extract_features(os.path.join(LFW_RESULTS_PATH, ALIGNED_FACES_DIR), os.path.join(LFW_RESULTS_PATH, FEATURES_CSV))